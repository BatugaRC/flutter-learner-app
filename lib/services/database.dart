...
class DatabaseService {
  ...
  Future<void> addCourse(String title, int length, String? creator) async {
    DocumentReference docRef = await courses.add(
      {"title": title, "length": length, "creator": creator, "students": [], "comments": []},
    );
  ...
  Future<DocumentSnapshot> getComment(String commentId) {
    return comments.doc(commentId).get();
  }

  Future<void> createComment(String content, String? courseId) async {
